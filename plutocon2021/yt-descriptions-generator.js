...
// you need to strip md from the abstracts
// this can be pretty simple:
// just render it pretty like in the calendar, and then when you copy from the page, only text will be copied

const template = ({NotebookLink, Abstract_but_without_md_syntax}) => `
${NotebookLink && `Demo notebook: ${NotebookLink /* don't show this line if there is no demo notebook */}` || ""}

${Abstract_but_without_md_syntax}
...
For the conference schedule, see: https://plutojl.org/plutocon2021
